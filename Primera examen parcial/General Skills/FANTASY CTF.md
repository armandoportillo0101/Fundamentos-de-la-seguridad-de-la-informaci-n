## Descripción
```
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF.Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 55224`
```
## Solución
```
┌──(Armando_Porti㉿DESKTOP-28KM9FK)-[~]
└─$  nc verbal-sleep.picoctf.net 55224
