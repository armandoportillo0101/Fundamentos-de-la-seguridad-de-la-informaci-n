...
## Solución
```
porti_04@DESKTOP-8HT902T:~/pico_retos/tercer_parcial/subs1$ wget https://artifacts.picoctf.net/c/183/message.txt
porti_04@DESKTOP-8HT902T:~/pico_retos/tercer_parcial/subs1$ cat message.txt
...
## Notas 
```
Para sacar la bandera copie todo el texto que contenia message.txt en:[https://quipqiup.com/](https://quipqiup.com/) y lo decodifiqué.
```
